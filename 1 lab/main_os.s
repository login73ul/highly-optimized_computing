...
LBB17_3:
	...
	callq	_printf
	movl	$5, %ebx
	movabsq	$4985484787499139072, %r14
	movabsq	$4841369599423283200, %r15
...
LBB17_5:
	...
	addq	%r14, %rcx
	movd	%rcx, %xmm1
	subsd	LCPI17_2(%rip), %xmm1
	movl	%eax, %eax
	addq	%r15, %rax
	movd	%rax, %xmm0
	addsd	%xmm1, %xmm0
	divsd	LCPI17_3(%rip), %xmm0
	divsd	LCPI17_4(%rip), %xmm0
	divsd	LCPI17_5(%rip), %xmm0
	movq	%r12, %rdi
	movb	$1, %al
	callq	_printf
	decl	%ebx
...
LBB19_2:
	...
	addq	%rdx, %rcx
	movd	%rcx, %xmm1
	subsd	LCPI19_2(%rip), %xmm1
	movl	%eax, %eax
	addq	%r14, %rax
	movd	%rax, %xmm0
	addsd	%xmm1, %xmm0
	divsd	LCPI19_3(%rip), %xmm0
	divsd	LCPI19_4(%rip), %xmm0
	divsd	LCPI19_5(%rip), %xmm0
	movq	%r15, %rdi
	movb	$1, %al
	callq	_printf
	decl	%ebx
...
_coeficent:
	...
	.comm	_fixCoeficent,144,4
	.comm	_coefTable,262144,4
	.comm	_fixCoefTable,786432,4
...
Leh_frame_end19:
	...
	.globl	_main.eh
_main.eh:
Lset104 = Leh_frame_end20-Leh_frame_begin20
	.long	Lset104
Leh_frame_begin20:
Lset105 = Leh_frame_begin20-Leh_frame_common
	.long	Lset105
Ltmp78:
	.quad	Leh_func_begin20-Ltmp78
Lset106 = Leh_func_end20-Leh_func_begin20
	.quad	Lset106
	.byte	0
	.byte	4
Lset107 = Ltmp48-Leh_func_begin20
	.long	Lset107
	.byte	14
	.byte	16
	.byte	134
